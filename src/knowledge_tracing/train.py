...
class NeuralBKTLightning(pl.LightningModule):
    ...
    def training_step(self, batch, batch_idx):
        ...
        bs = output.size(0)
        self.log("train_loss", loss, prog_bar=True, on_step=False, on_epoch=True, batch_size=bs)
        self.log("train_acc", train_acc, prog_bar=True, on_step=False, on_epoch=True, batch_size=bs)
        return loss
    ...
    def validation_step(self, batch, batch_idx):
        ...
        self.log("val_acc", val_acc, prog_bar=True, on_step=False, on_epoch=True, batch_size=bs)
        self.log(
            "val_auc", self.val_auc, prog_bar=True, on_step=False, on_epoch=True, batch_size=bs
        )
        return loss
    ...
    def test_step(self, batch, batch_idx):
        ...
        self.log("test_loss", loss, on_step=False, on_epoch=True, batch_size=output.size(0))
        self.log("test_acc", test_acc, on_step=False, on_epoch=True, batch_size=output.size(0))
        self.log("test_auc", self.test_auc, on_step=False, on_epoch=True, batch_size=output.size(0))
        return loss
